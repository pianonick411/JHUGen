...
!       print *, "before",ggWW(:,:)
      ...
      ggWW(1,1)=dcmplx(xq1/s34)*dcmplx(xq2/s56)* dAAWpWm
...
C---end statement function
      ...
      sr_cW = cW*(2d0*za(i1,i3)*zb(i4,i7)*(
